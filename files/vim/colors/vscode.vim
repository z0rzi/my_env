...
hi Folded       cterm=None    ctermbg=None      ctermfg=darkgray
...
hi StatusLine   cterm=Bold    ctermbg=black     ctermfg=red
hi WildMenu     cterm=None    ctermbg=red       ctermfg=Black
...
hi Define cterm=None ctermbg=None ctermfg=red
hi Delimiter cterm=bold ctermbg=None ctermfg=white
...
hi Type       cterm=italic ctermfg=Blue
