...
syntax match   javaScriptFunctionCall   "\w\+\ze(" display nextgroup=javaScriptFunctionArgs
" syntax match   javaScriptFunctionArgs   "([^)]*)" display contained contains=all
"}}}
...
if version >= 508 || !exists("did_javascript_syn_inits")
	...
	HiLink javaScriptFunctionCall           Identifier
